...
public class NewHandler {
	...
	public void execute(@Active Shell shell, @Active MWindow window,
		...
		String [] filterNames = new String [] {"Reveal File", "All Files (*)"};
		String [] filterExtensions = new String [] {"*.reveal", "*"};
		...
		if (filepath != null) {
			...
			Presentation pres = RevealFactory.eINSTANCE.createPresentation();
			resource.getContents().add(pres);
			try {
				resource.save(null);
